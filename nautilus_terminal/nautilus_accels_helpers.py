...
def remove_nautilus_accels(nautilus_app):
    if not NAUTILUS_ACCELS_BACKUP:
        logger.error("remove_nautilus_accels: Accels will not be removed: accels have not been backuped")
        return
...
def restore_nautilus_accels(nautilus_app):
    if not NAUTILUS_ACCELS_BACKUP:
        logger.error("remove_nautilus_accels: Accels cannot be restored: accels have not been backuped")
        return
